...
public class DataLoader implements CommandLineRunner {
    ...
    private List<Course> createCourses(List<Category> categories, List<User> users) {
        ...
        courses.add(Course.builder()
                ...
                .duration("무료배송")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(324)
                .rating(4.8)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("무료배송")
                .level("성견")
                .thumbnailUrl("https://images.unsplash.com/photo-1558788353-f76d92427f16?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(267)
                .rating(4.9)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(456)
                .rating(4.9)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(389)
                .rating(4.7)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(198)
                .rating(4.6)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("중대형견")
                .thumbnailUrl("https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(276)
                .rating(4.8)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("소형견")
                .thumbnailUrl("https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(342)
                .rating(4.5)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("무료배송")
                .level("전체")
                .thumbnailUrl("https://images.unsplash.com/photo-1568393691622-c7ba131d63b4?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(412)
                .rating(4.7)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전체")
                .thumbnailUrl("https://images.unsplash.com/photo-1591160690555-5debfba289f0?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(298)
                .rating(4.6)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("노령견")
                .thumbnailUrl("https://images.unsplash.com/photo-1477884213360-7e9d7dcc1e48?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(187)
                .rating(4.8)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1552053831-71594a27632d?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(234)
                .rating(4.9)
                .build());
        ...
        courses.add(Course.builder()
                ...
                .duration("2-3일")
                .level("전연령")
                .thumbnailUrl("https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=400&h=200&fit=crop")
                .published(true)
                .enrollmentCount(156)
                .rating(4.7)
                .build());
